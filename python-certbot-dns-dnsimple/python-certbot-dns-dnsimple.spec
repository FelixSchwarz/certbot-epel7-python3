...
BuildRequires:  python2-dns-lexicon >= 3.2.1
...
Requires:       python2-dns-lexicon >= 3.2.1
...
%license LICENSE.txt
%doc README.rst
%{python2_sitelib}/certbot_dns_dnsimple
%{python2_sitelib}/certbot_dns_dnsimple-%{version}-py?.?.egg-info
%endif
