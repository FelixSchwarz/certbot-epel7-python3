...
BuildRequires:  python2-dns-lexicon >= 2.2.3
...
Requires:       python2-dns-lexicon >= 2.2.3
...
%license LICENSE.txt
%doc README.rst
%{python2_sitelib}/certbot_dns_linode
%{python2_sitelib}/certbot_dns_linode-%{version}-py?.?.egg-info
%endif
